      ...
      <section className='home_bloques container-fluid'>
        <div className='row bloques_info' >
          ...
          <div className='bloque_cont bloque col-lg-4 text-center text-uppercase'>
            ...
            <h5 className='font-weight-bold pt-2'>pagá como quieras</h5>
      ...
      <section className='imagen-grid container-fluid'>
        ...
        <div className="imagen_text1 my-auto">
          <div className="content_left ">
            <h2 className='text-justify'>Frente al mate, somos todos iguales.</h2>
            <p className='text-justify'>
              El mate es un ícono nacional que va más allá de una tradición cultural y que trasciende fronteras.
              A este compañero fiel nos une un vínculo emocional, una pasión.
              Lleva implícito el sello personal de cada matero.
            </p>
          </div>
        </div>
